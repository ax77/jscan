...
#define macros_unused(arg)  static_cast<void>(arg)
...
struct ignore_assign {
    ...
    const ignore_assign& operator =(int dummy) {macros_unused(dummy); return *this; }
...
struct EnumName {                                                      \
    ...
    _enumerated& operator=(_enumerated value) { return _value = value;}\
                                                                       \
